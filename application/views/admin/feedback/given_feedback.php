...
<table cellspacing="0" cellpadding="0" border="0" class="scroller" >
    <thead>
        <tr class="quicklinks">
            <td colspan='5'>
                                    <div class="head-blue" style="background-color: #EAE1E6;">My Feedbacks to
                                      
           <div style="margin-right:10px; float:right"> <input type="radio" name="feedback" value="Translators" checked="checked"> Translators
                  <input type="radio" name="feedback" value="Client">Client</div></div>
				</td></tr>
            </thead>
</table>
