<form id="ongoingform" action="<?php echo WEB_URL; ?>projects/changeStatus" method="POST">	
...
<!--onchange="window.location='<?php echo WEB_URL;?>projects/changeStatus?id='+<?php //echo $prolist['pro_id_pk']; ?>;"-->
<script>
$('.ab').change(function(){
$( "form:first" ).submit();
 });
