...
<div class="col_left" style="border-right:1px dashed #CDCDCD;">
    <form>
        <ul class="searchfilter">
            ...
            <select class="slanguage selectall">
            ...
            <br />
            <select class="tlanguage selectall">
                <option value="" selected="selected">Target Language</option>
                <option value="English">English</option>
                <option value="Russian">Russian</option>
                <option value="Chinese">Chinese</option>
                <option value="Spanish">Spanish</option>
...
<div class="col_right">
    ...
    <ul>
        <?php
        $i = 0;
        foreach ($preflistres as $list1) {
            //echo $list1['user_type'];
            if ($list1['user_type'] == 2) {
                    $name=$list1['it_patronymic']." ".$list1['it_first_name'] . " " . $list1['it_last_name'];
                    $about=$list1['it_about'];
                } else if ($list1['user_type'] == 3) {
                    $name=$list1['tc_first_name'];
                    $about=$list1['tc_about'];
                } 
            ?>
            <li>
                <div class="proj_left">
    ...
    <?php } ?>
                    ...
                    <a href="<?php echo WEB_URL; ?>tastatranslators/transProfile/?id=<?php echo $list1['user_id_fk']; ?>" style="text-decoration: none" class="head-blue1"><h3><?php echo $name . " " . $list1['user_id_fk']; ?></h3></a>
    ...
    $(document).ready(function() {
        ...
        $(".selectall").on("change", function() {
            ...
            if (tval == "" && eval == "" && slang == "" && tlang == "" && loc == "") {
                location.href = "<?php echo WEB_URL; ?>tastatranslators/preferred_translators";
            }
            var action = "<?php echo WEB_URL; ?>tastatranslators/preftransfilter";
            $.ajax({
                url: action,
                type: "POST",
