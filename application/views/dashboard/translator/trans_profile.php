...
<div class="main_content_box_5" ><?php //print_r($itandtcdata); ?>
    <div class="head-blue1" > <?php echo $itandtcdata[0]['it_first_name'] . " " . $itandtcdata[0]['it_last_name']; ?> </div> 
    <span id="location">Location :  <?php echo $itandtcdata[0]['it_city'] . "," . $itandtcdata[0]['it_country']; ?><br>
        &nbsp;Member Since:<?php echo $itandtcdata[0]['user_registrations_date']; ?></span>
    <table width="100%" border=0 cellspacing="0" cellpadding="0" style="margin-top: 65px;">
        <thead>
            <tr>
            <td  rowspan=3 width="100px" height="180px">
                <img id="profileimg" width="179px"  height="223px"src="<?php echo WEB_PATH; ?>images/dpm.jpg"/>
            </td>
            <div class="content_box2" style="margin: -60px 220px;"> 	
            ...
            <tr><td>         
                ...
                <p id="profiledesc">
                     <?php echo $itandtcdata[0]['it_about']; ?>
                </p> 
                <p class="flip">Click Here To See My Skills 
        ...
        <tbody>
            ...
            <td align="center" >
                ...
                <div class="feedback">
                <a id="portfolio" href="<?php echo WEB_URL; ?>feedback/Feedbacks"><h3>Feedback</h3></a>
                </div>
            </td>
            <td>         	
                <table cellspacing="0" cellpadding="0" border="0" width="100%" >
                    ...
                    <tbody>
                        ...
                        <td>
                           <div id="tabs">
  			<ul id="switch_ul" >
                                    <li><a href="#tab-1" class="active">Completed Work</a></li>
                                ...
                                <div id="tab-1">
                                    ...
                                    <span style="font-family:'Segoe UI';">Project Description:</span> 
