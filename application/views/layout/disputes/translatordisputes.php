   <strong style="font-size:18px; color:#1d71a8; padding-left:0px;">Disputes</strong>
   <hr><br>   <form>
		...
		<tbody>	
            ...
            <tr>
				<td>&nbsp;  </td>
				<td><input type="button" class="button" value="SUBMIT" id="dispute" /></td>
			</tr>
		</tbody>	
...
if(result == true){
    $.ajax({
                 success: function() {
                        window.location.href =ur+"index.php/finance/viewtransDisputes" ;}
