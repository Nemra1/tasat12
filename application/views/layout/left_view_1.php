...
<div class="content"> 
    <div class="content_left">
        <div class="leftside_1">  
            <p style="margin: 0px; text-align: center; font-weight: bold; padding: 2px; background-color: #c5d0d8; border: 1px solid #002a80;">Your Profile has been activated now.<br> You can now login to view your profile.</p>
        </div>
