<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#profiledesc').mouseover(function() {
            $('.hover_pd').show();
        });
        $('#profiledesc').mouseout(function() {

            $('.hover_pd').hide();
        });
        $('#profiledesc').click(function() {
            $('#save_button').show();
            $('#cancel_button').show();
        });
        $('#save_button').click(function() {
            var uptext = $('#profiledesc').text();
            $('#save_button').hide();
            $.post("<?php echo WEB_URL; ?>home/edit", {
                uptext: uptext
            }, function(data) {
                alert(data);
            });
...
<div class="main_content_box_5" >
    <div >
        ...
        </span>&nbsp;&nbsp;<a id="save_location"><img id="save_img"src="<?php echo WEB_PATH; ?>images/save.png"/></a>
        <a id="edit_link"><img id="edit_img"src="<?php echo WEB_PATH; ?>images/edit_icon.png" style="height:14px;width:14px;"  title="Edit"></a><span id="edit_label">Edit</span>
    </div>
    <table width="100%" border=0 cellspacing="0" cellpadding="0">
        ...
        <tr><td> <div class="head-blue">Chinese translation,live video translation</div>        
                <div class="profiledesc" >
                    <p id="profiledesc" onClick="this.contentEditable = 'true';">I am Mr.Peter John from Bangalore, India.Iam working in this field for last 4 years.
                    ...
                    <span class="hover_pd">Click Anywhere to Edit</span></div>
        ...
        <tbody>
            <tr align=center>
                <td align="center" >
                    ...
                    <a id="portfolio" ><h3>Resume</h3></a>
                    <a id="portfolio" ><h3>Feedback</h3></a>
                                ...
                                <td>
                                    <div id="tabs">
                                        <ul class="translate-nav-tabs">
                                            <li><a href="#tab-1">Project Posted</a></li>
