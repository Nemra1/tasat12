...
class Itranslator extends CI_Controller {

    function index() {
        //start
        redirect(WEB_URL . 'itranslator/logindetails');
        //end	
    }
...
//        $this->load->view('Itranslator/ilogin_view');
...
//    }
        ...
        else
        {
                ...
                if ($this->email->send()) {
                    ...
                    redirect(WEB_URL.'itranslator/personalinfo');
...
//        $this->load->view('cms/langnmenu2_view');
//        $this->load->view('cms/bluestrip3_view');
//        $this->load->view('Itranslator/ilogin_step2_view');
//        $this->load->view('cms/registeration5_view');
//        $this->load->view('cms/footer6_view');
//        //end	
//    }
        ...
        else
        {
            ...
            $pic = $_FILES['profilepic']['name'];
                ...
                if($doc != "")
                {
                 ...
                 {
                     redirect(WEB_URL.'itranslator/pricing');
...
//        echo $dob = $_POST['dob'];
//        echo $native = $_POST['native'];
//        echo $country = $_POST['country'];
//        echo $add = $_POST['address'];
//        echo $city = $_POST['city'];
//        echo $zipcd = $_POST['zipcode'];
//        echo $smail = $_POST['smail'];
//        echo $pcontact = $_POST['pcontact'];
//        echo $scontact = $_POST['scontact'];
//        echo $fax = $_POST['fax'];
//        echo $sval1 = $_POST['suid'];
//        //$sval2 = $_POST['suname'];
//        echo $sval3 = $_POST['semail'];
//
//        /*********file upload********/
//
...
//            //print_r($imageData);
//            $success = $this->user_model->additprofile($about, $add, $city, $country, $dob, $fax, $native, $pcontact, $scontact, $smail, $zipcd, $dp_path, $pdoc_path, $sval1, $sval3);
//            if ($success == FALSE) {
//                redirect(WEB_URL . 'itranslator/pricing');
//            }
//        }
//    }
    ...
    function pricing() {
        ...
        if($data['suid']== "")
        {
            ...
            $this->load->view('cms/langnmenu2_view');
            $this->load->view('cms/bluestrip3_view');
            $this->load->view('Itranslator/ilogin_step3_view');
            $this->load->view('cms/registeration5_view');
            $this->load->view('cms/footer6_view');
        }
        //end	
    ...
    function enterpricing(){
        ...
        $currency2 = $_POST['currency2'];
            $userexpertise1 = $this->user_model->userexpertise1($userid,$expval,$domain,$source,$target,$rpw,$currency1,$rpm,$currency2);
            //print_r($userexpertise1);
            $sample = '<table>';
            $sample.='<tr>
                <th>user id</th>
                <th cols="2">Language Pair</th>
                <th>Rate per min</th>
                <th>Rate per word</th>
                </tr>';
    ...
    function showexp(){
        ...
        if($data['suid']== "")
        {
            ...
            $showexpertise = $this->user_model->showexpertise($userid);
        }
    }
...
//END of itranslator.php controller..
}
